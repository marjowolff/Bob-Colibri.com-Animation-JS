...
//Affichage choix internaute (chevaux)
const cheval=document.getElementById('chevaux')
const frison = document.getElementById('frison')
const pponey = document.getElementById('pponey')
const psarabe = document.getElementById('psarabe')
cheval.addEventListener('change',afficheCheval)

function afficheCheval (e) {
    console.log('Cheval sélectionné')
